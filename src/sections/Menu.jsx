...
const Menu = () => {
  ...
  const menuData = {
    ...
    boissons: {
      title: 'Boissons',
      subtitle: 'Apéritifs, cocktails, cidres artisanaux, bières & vins',
      sections: [
        {
          name: 'Apéritifs',
          items: [
            { name: 'Pastis', price: '3,30€', unit: '2cl' },
            { name: 'Kir, kir breton', desc: 'Cassis, mûre, framboise, pêche', price: '4,10€', unit: '14cl' },
            { name: 'Martini', desc: 'Blanc, rouge, dry', price: '4,20€', unit: '6cl' },
            { name: 'Porto', desc: 'Blanc, rouge', price: '3,80€', unit: '10cl' },
            { name: 'Pommeau Séhédic', price: '4,00€', unit: '10cl' },
            { name: 'Champagne Chassenay d\'Arce — Bouteille', price: '60,00€', unit: '75cl' },
            { name: 'Champagne Chassenay d\'Arce — Coupe', price: '12,00€', unit: '16cl' },
          ],
        },
        {
          name: 'Cocktails',
          items: [
            { name: 'Mojito ou Mojito Fraise', desc: 'Rhum Havana, menthe, citron vert, sucre, eau gazeuse ou jus de fraise', price: '9,00€', unit: '25cl' },
            { name: 'Mojito Royal', desc: 'Rhum Havana, menthe, citron vert, sucre, champagne', price: '12,00€', unit: '25cl' },
            { name: 'Caïpirinha', desc: 'Cachaça, citron vert, sucre', price: '7,50€', unit: '6cl' },
            { name: 'Planteur', desc: 'Rhum Havana, cocktail de fruits, sirop de grenadine', price: '8,50€', unit: '25cl' },
            { name: 'Américano', desc: 'Campari, Martini rouge, Martini dry, orange', price: '7,50€', unit: '7cl' },
            { name: 'Tequila Sunrise', desc: 'Tequila, jus d\'orange, sirop de grenadine', price: '8,00€', unit: '20cl' },
            { name: 'Gin Tonic', desc: 'Gin Bombay, Schweppes tonic, citron jaune', price: '9,00€', unit: '20cl' },
            { name: 'Hendrick\'s Tonic', desc: 'Gin Hendrick\'s, Schweppes tonic, citron jaune', price: '10,00€', unit: '20cl' },
            { name: 'Ti Punch', desc: 'Rhum Trois Rivières, citron vert, sucre de canne', price: '7,00€', unit: '6cl' },
            { name: 'Apérol Spritz', desc: 'Apérol, Prosecco, eau gazeuse, orange', price: '7,50€', unit: '12cl' },
            { name: 'Sarti Spritz', desc: 'Sarti Rosa (mangue passion), prosecco, eau gazeuse', price: '8,50€', unit: '12cl' },
            { name: 'Karl\'tini', desc: 'Martini rouge, Martini blanc, La French pamplemousse', price: '9,50€', unit: '15cl' },
          ],
        },
        {
          name: 'Alcool',
          items: [
            { name: 'Whisky Ballantine\'s', price: '6,00€', unit: '4cl' },
            { name: 'Vodka Absolut', price: '6,00€', unit: '4cl' },
            { name: 'Gin Hendrick\'s', price: '7,00€', unit: '4cl' },
            { name: 'Tequila Jose Cuervo especial', price: '6,00€', unit: '4cl' },
            { name: 'Rhum Havana', price: '6,00€', unit: '4cl' },
            { name: 'Jack Daniel\'s', desc: 'Avec accompagnement +2,50€', price: '6,50€', unit: '4cl' },
            { name: 'Aberlour 10 ans', price: '7,00€', unit: '4cl' },
            { name: 'Aberlour 12 ans', price: '9,50€', unit: '4cl' },
            { name: 'Diplomatico Rhum Venezuela', price: '8,00€', unit: '4cl' },
            { name: 'Zacapa 23 ans Rhum Guatemala', price: '10,00€', unit: '4cl' },
          ],
        },
        {
          name: 'Bières',
          items: [
            ...
            { name: 'La Dilettante', desc: 'Bière bio vannetaise — Blonde pale ale, Blanche IPA, Blonde orangée IPA', price: '7,50€', unit: '33cl' },
          ],
        },
        {
          name: 'Cidres',
          items: [
            ...
            { name: 'Cidre Ecusson rosé', desc: 'Doux', price: '12,00€', unit: '75cl' },
            { name: 'Séhédic Cidre bio artisanal', desc: 'La Forêt-Fouesnant — Brut, Demi-sec, Doux', price: '15,50€', unit: '75cl' },
            { name: 'Séhédic Cidre bio artisanal', desc: 'Brut ou Doux', price: '7,00€', unit: '33cl' },
            { name: 'Séhédic Cidre bio d\'exception Extra-Brut', desc: 'Pommes douces amères et acidulées, fermentation très longue, fines bulles, très peu sucré', price: '24,00€', unit: '75cl' },
            { name: 'Kertoban', desc: 'Pommes anciennes à dominante amère, présence fruitée marquée, légèrement fumé, couleur orange vif', price: '23,00€', unit: '75cl' },
          ],
        },
        {
          name: 'Vins Rouges',
          description: 'Verre 12,5cl / Bouteille 75cl',
          items: [
            { name: 'AOP Saumur-Champigny « Pour Les Potes » 2024', desc: 'Notes légères et fruitées', price: '3,90€ / 23,90€', unit: 'verre / bout.' },
            { name: 'AOP Pic Saint Loup « Ailes et Moi » 2023', desc: 'Vin frais et croquant, arômes de fruits rouge mûrs et d\'épices', price: '4,90€ / 29,50€', unit: 'verre / bout.' },
            { name: 'AOP Languedoc — Grès de Montpellier « Mas de Lunès » 2021', desc: 'Robe sombre, arômes expressifs, notes de cacao, vanille, finale épicée et mentholée', price: '35,00€', unit: 'bouteille' },
          ],
        },
        {
          name: 'Vins Blancs',
          description: 'Verre 12,5cl / Bouteille 75cl',
          items: [
            { name: 'Muscadet s/Lie Domaine de la Grange 2024', desc: 'Robe jaune clair, nez légèrement iodé, vif, frais, tonique', price: '3,40€ / 20,00€', unit: 'verre / bout.' },
            { name: 'IGP Val de Loire « Le Ch\'nin » 2024', desc: 'Vin sec minéral frais aux notes fruitées', price: '4,10€ / 24,70€', unit: 'verre / bout.' },
            { name: 'IGP Côtes Catalanes « Le Canon du Maréchal » 2023', desc: 'Nez aromatique de fleurs blanches et pamplemousse, note de poire et de pêche blanche', price: '4,90€ / 29,20€', unit: 'verre / bout.' },
          ],
        },
        {
          name: 'Vins Rosés',
          description: 'Verre 12,5cl / Bouteille 75cl',
          items: [
            { name: 'IGP Méditerranée « J\'peux pas j\'ai rosé » 2024', desc: 'Robe rose très clair, vin frais et fruité tout en finesse et en douceur', price: '4,30€ / 25,60€', unit: 'verre / bout.' },
            { name: 'AOP Coteaux d\'Aix en Provence « Bargemone » 2024', desc: 'Vin frais et élégant, arômes de fleurs blanches, d\'agrumes et de petits fruits rouges', price: '5,10€ / 30,70€', unit: 'verre / bout.' },
          ],
        },
        {
          name: 'Sans Alcool',
        ...
        },
        {
          name: 'Eaux',
          items: [
            { name: 'Plancoët', price: '4,50€', unit: '1l' },
            { name: 'Plancoët', price: '2,50€', unit: '50cl' },
            { name: 'Plancoët Fines bulles', price: '4,50€', unit: '1l' },
            { name: 'Plancoët Fines bulles', price: '2,50€', unit: '50cl' },
          ],
        },
        {
        ...
        },
        {
          name: 'Digestifs',
          items: [
            { name: 'Poire-Williams', price: '8,00€', unit: '4cl' },
            { name: 'Cognac Hennessy VSOP', price: '8,00€', unit: '4cl' },
            { name: 'Cognac aux amandes', price: '8,00€', unit: '4cl' },
            { name: 'Calvados VSOP', price: '6,00€', unit: '4cl' },
            { name: 'Chouchen', price: '6,00€', unit: '6cl' },
            { name: 'Bailey\'s', price: '6,00€', unit: '4cl' },
            { name: 'Get 27', price: '6,00€', unit: '4cl' },
            { name: 'Menthe-pastille', price: '6,00€', unit: '4cl' },
